...
#define	PROTOCOL_NAME				_T("localhost")

#define WIN32_SEMAPHORE_NAME		_T("MacromediaMutexOmega")
#define WIN32_SHMEM_NAME			_T("MacromediaFMOmega")
#define POSIX_SEMAPHORE_NAME		_T("MacromediaSemaphoreDig")
